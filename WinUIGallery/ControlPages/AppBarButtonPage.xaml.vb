...
Namespace AppUIBasics.ControlPages
    Public NotInheritable Partial Class AppBarButtonPage
        Inherits Page
        ...
        Private Sub AppBarButton_Click(sender As Object, e As RoutedEventArgs)
            Dim TempVar1 As Boolean = TypeOf sender Is Button
            ...
            If TempVar1 Then
                ...
                Select Case name1
                    ...
                    Case "Button3"
                        Control3Output.Text = "You clicked: " & name1
                    Case "Button4"
                        Control4Output.Text = "You clicked: " & name1
                    Case "Button5"
                        Control5Output.Text = "You clicked: " & name1
                End Select
            End If
        End Sub
